        ...
        <html lang="fr">
            <head>
                ...
                <meta
                    ...
                    content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.twitch.tv https://player.twitch.tv; style-src 'self' 'unsafe-inline'; img-src 'self' https://*.twitch.tv https://static-cdn.jtvnw.net data:; frame-src 'self' https://clips.twitch.tv https://player.twitch.tv https://www.twitch.tv; connect-src 'self' https://api.twitch.tv https://id.twitch.tv; frame-ancestors 'self' https://daems-app.vercel.app;"
                />
            </head>
            <body>{children}</body>
        </html>
